    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    TelaCadastroRequisicao telaRequisicao = (TelaCadastroRequisicao)telaSelecionada;

                    if (opcaoSelecionada == "1")
                        telaRequisicao.RegistrarRequisicao();

                    if (opcaoSelecionada == "2")
                        telaRequisicao.VisualizarRequisicao();

                    if (opcaoSelecionada == "3")
                        telaRequisicao.VisualizarRequisicaoEmAberto();
                }
            }
        }
    }
