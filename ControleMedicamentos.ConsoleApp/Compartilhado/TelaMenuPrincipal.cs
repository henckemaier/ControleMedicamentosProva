...
namespace ControleMedicamentos.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroRequisicao = new TelaCadastroRequisicao(notificador, repositorioRequisicao, repositorioRemedio, repositorioPaciente, telaCadastroRemedio, telaCadastroPaciente);
        }
        ...
        public string MostrarOpcoes()
        {
            ...
            Console.WriteLine("Digite 3 para Gerenciar Remédios");
            Console.WriteLine("Digite 4 para Gerenciar Pacientes");
            Console.WriteLine("Digite 5 para Gerenciar Requisição");
